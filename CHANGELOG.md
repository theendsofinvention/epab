...
## 2018.10.29.2 (2018-10-29)
### New
* Optional twine upload (#133) [etcher]
  * chg: dev: update reqs
  * new: add config switch for twine upload
## 2018.10.29.1 (2018-10-29)
### Other
* Build(deps): bump elib-run from 2018.10.21.1 to 2018.10.26.1. [dependabot[bot]]
  Bumps [elib-run](https://github.com/etcher-be/elib_run) from 2018.10.21.1 to 2018.10.26.1.
  - [Release notes](https://github.com/etcher-be/elib_run/releases)
  - [Commits](https://github.com/etcher-be/elib_run/compare/2018.10.21.1...2018.10.26.1)
* Build(deps): bump hypothesis from 3.80.0 to 3.81.0. [dependabot[bot]]
  Bumps [hypothesis](https://github.com/HypothesisWorks/hypothesis) from 3.80.0 to 3.81.0.
  - [Release notes](https://github.com/HypothesisWorks/hypothesis/releases)
  - [Commits](https://github.com/HypothesisWorks/hypothesis/compare/hypothesis-python-3.80.0...hypothesis-python-3.81.0)
* Build(deps): bump elib-config from 2018.10.24.1 to 2018.10.26.1. [dependabot[bot]]
  Bumps [elib-config](https://github.com/etcher-be/elib_config) from 2018.10.24.1 to 2018.10.26.1.
  - [Release notes](https://github.com/etcher-be/elib_config/releases)
  - [Commits](https://github.com/etcher-be/elib_config/compare/2018.10.24.1...2018.10.26.1)
